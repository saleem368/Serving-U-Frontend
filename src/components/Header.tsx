    ...
    <header className="w-full bg-white shadow-sm px-2 md:px-8 py-2 flex flex-col md:flex-row items-center justify-between gap-2 md:gap-0 sticky top-0 z-30">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-6 items-center">
          {/* Helpline integrated into navigation */}
          <a href="tel:8427631266" className="flex items-center gap-1 text-gray-700 hover:text-blood-red-600 transition-colors">
        ...
        {isAuthenticated ? (
          <div className="relative">
            ...
            {showProfileMenu && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-200 z-50 flex flex-col profile-menu">
                ...
                {/* Helpline for mobile */}
                <div className="md:hidden px-4 py-3 flex items-center gap-2 text-blood-red-600 border-b">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  </svg>
                  <a href="tel:8427631266" className="text-sm font-medium">
                    Helpline No.
                  </a>
                </div>
          ...
          <div className="flex items-center gap-4">
            {/* Mobile helpline for non-authenticated users */}
            <div className="md:hidden flex items-center gap-2 text-blood-red-600">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
              </svg>
              <a href="tel:8427631266" className="text-sm font-medium">
